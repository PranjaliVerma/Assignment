    ...
    <div className="full-container" style={ss}>
      <Router>
        <div className="sidebar">
            <div  style={mystyle1}>
                  <ol style={mystyle3} >        
                      ...
                      <li  style={mystyle4} >    
                      <button class="ButtonStyle2"><i style={{"margin-right":"10px"}} class="fa fa-address-book-o"></i>User List</button>   
                      </li>
                      <li style={mystyle4} >    
        ...
        <div style={{ "width": "80%" , "margin":"none", "marginBottom":"40px"}} >
                      <h1 style={{ "text-shadow": "2px 2px 4px #000000"}}> <center>User List</center></h1>
